...
//! Bitriel Client abstractions.
#![allow(unused_variables)]

use bitriel_primitives::{AccountId, Balance, Block, BlockNumber, Hash, Header, Nonce};
...
///
/// As there exist multiple chains inside Bitriel, like Bitriel itself, Karura,
/// Rieltest etc, there can exist different kinds of client types. As these
...
/// A handle to a Bitriel client instance.
///
/// The Bitriel service supports multiple different runtimes (Karura, Bitriel
...
/// A client instance of Bitriel.
#[derive(Clone)]
pub enum Client {
	#[cfg(feature = "with-rieltest-runtime")]
	Rieltest(Arc<crate::FullClient<rieltest_runtime::RuntimeApi>>),
	#[cfg(feature = "with-bitriel-runtime")]
	Bitriel(Arc<crate::FullClient<bitriel_runtime::RuntimeApi>>),
}
