...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("bitriel-parachain"),
	impl_name: create_runtime_str!("bitrieln"),
	authoring_version: 1,
	spec_version: 1,
	impl_version: 0,
...
construct_runtime!(
	pub enum Runtime where
		Block = Block,
		NodeBlock = bitriel_primitives::Block,
...
impl_runtime_apis! {
	...
	impl frame_try_runtime::TryRuntime<Block> for Runtime {
		fn on_runtime_upgrade() -> (Weight, Weight) {
			log::info!("try-runtime::on_runtime_upgrade bitriel-parachain.");
